                ...
                for (let user of participants) {
                    ...
                    try {
                        ...
                        let wel = API('males', '/welcome2', {
                                ...
                                background: 'https://telegra.ph/file/5ae5075cf08c28c45462e.jpg',
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: '*𝐎𝐧𝐥𝐢 𝐃𝐞𝐯𝐨𝐥𝐮𝐯𝐞𝐫* • 𝑪𝒐𝒎𝒎𝒂𝒏𝒅 𝑰𝒏𝒊 𝑯𝒂𝒏𝒚𝒂 𝑫𝒊 𝑮𝒖𝒏𝒂𝒌𝒂𝒏 𝑶𝒍𝒆𝒉 𝑫𝒆𝒗𝒐𝒍𝒖𝒑𝒆𝒓 𝑩𝒐𝒕',
        owner: '*𝐎𝐧𝐥𝐢 𝐎𝐰𝐧𝐞𝐫* • 𝑪𝒐𝒎𝒎𝒂𝒏𝒅 𝑰𝒏𝒊 𝑯𝒂𝒏𝒚𝒂 𝑫𝒊 𝑮𝒖𝒏𝒂𝒌𝒂𝒏 𝑶𝒍𝒆𝒉 𝑶𝒘𝒏𝒆𝒓 𝑩𝒐𝒕',
        mods: '*𝐎𝐧𝐥𝐢 𝐌𝐨𝐝𝐞𝐫𝐚𝐭𝐨𝐫* • 𝑪𝒐𝒎𝒎𝒂𝒏𝒅 𝑰𝒏𝒊 𝑯𝒂𝒏𝒚𝒂 𝑫𝒊 𝑮𝒖𝒏𝒂𝒌𝒂𝒏 𝑶𝒍𝒆𝒉 𝑴𝒐𝒅𝒆𝒓𝒂𝒕𝒐𝒓 𝑩𝒐𝒕ᴛ',
        premium: '*𝐏𝐫𝐞𝐦𝐢𝐮𝐦 𝐎𝐧𝐥𝐢* • 𝐌𝐨𝐝𝐞𝐫𝐚𝐭𝐨𝐫* • 𝑪𝒐𝒎𝒎𝒂𝒏𝒅 𝑰𝒏𝒊 𝑯𝒂𝒏𝒚𝒂 𝑫𝒊 𝑮𝒖𝒏𝒂𝒌𝒂𝒏 𝑶𝒍𝒆𝒉 𝑷𝒓𝒆𝒎𝒊𝒖𝒎 𝑼𝒔𝒆𝒓',
        group: '*𝐆𝐫𝐨𝐮𝐩 𝐂𝐡𝐚𝐭* • 𝑪𝒐𝒎𝒎𝒂𝒏𝒅 𝑰𝒏𝒊 𝑯𝒂𝒏𝒚𝒂 𝑫𝒊 𝑷𝒂𝒌𝒂𝒊 𝑫𝒊 𝑮𝒓𝒐𝒖𝒑',
        private: '*𝐂𝐡𝐚𝐭 𝐕𝐫𝐢𝐯𝐚𝐭𝐞* •𝑪𝒐𝒎𝒎𝒂𝒏𝒅 𝑰𝒏𝒊 𝑯𝒂𝒏𝒚𝒂 𝑫𝒊 𝑷𝒂𝒌𝒂𝒊 𝑫𝒊 𝑽𝒓𝒊𝒗𝒂𝒕𝒆 𝑪𝒉𝒂𝒕',
        admin: '*𝐀𝐝𝐦𝐢𝐧 𝐆𝐫𝐨𝐮𝐩* • 𝑪𝒐𝒎𝒎𝒂𝒏𝒅 𝑰𝒏𝒊 𝑯𝒂𝒏𝒚𝒂 𝑫𝒊 𝑮𝒖𝒏𝒂𝒌𝒂𝒏 𝑼𝒏𝒕𝒖𝒌 𝑨𝒅𝒎𝒊𝒏 𝑮𝒓𝒐𝒖𝒑',
        botAdmin: '*𝐎𝐧𝐥𝐢 𝐁𝐨𝐭 𝐀𝐝𝐦𝐢𝐧* • 𝑪𝒐𝒎𝒎𝒂𝒏𝒅 𝑰𝒏𝒊 𝑯𝒂𝒏𝒚𝒂 𝑫𝒊 𝑮𝒖𝒏𝒂𝒌𝒂𝒏 𝑲𝒆𝒕𝒊𝒌𝒂 𝑩𝒐𝒕 𝑨𝒅𝒎𝒊𝒏 𝑮𝒓𝒐𝒖𝒑 ',
        //unreg: '*ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ʀᴇɢɪsᴛᴇʀᴇᴅ ʏᴇᴛ* • ᴋᴇᴛɪᴋ  .daftar ᴜɴᴛᴜᴋ ʙɪsᴀ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ ғɪᴛᴜʀ ɪɴɪ', 
        restrict: '*ʀᴇsᴛʀɪᴄᴛ* • 𝐑𝐞𝐬𝐭𝐚𝐫𝐢𝐜𝐫 𝐁𝐞𝐥𝐮𝐦 𝐃𝐢𝐧𝐲𝐚𝐥𝐚𝐤𝐚𝐧 𝐃𝐢𝐜𝐡𝐚𝐭 𝐈𝐧𝐢𝐥',
    }[type]
    if (msg) return conn.send2ButtonDoc(m.chat, msg, author, '💌 Creator', '.creator', '🎀 Menu', '.menu', fakes, adReply)
    let msgg = {
    	unreg: '𝐇𝐚𝐥𝐨 𝐊𝐚𝐤 👋\𝐀𝐧𝐝𝐚 𝐇𝐚𝐫𝐮𝐬 𝐌𝐞𝐧𝐝𝐚𝐟𝐭𝐫 𝐃𝐮𝐥𝐮 𝐒𝐞𝐛𝐞𝐥𝐮𝐦 𝐌𝐞𝐧𝐠𝐠𝐮𝐧𝐚𝐤𝐚𝐧 𝐅𝐢𝐭𝐮𝐫 𝐈𝐧𝐢\n\n➞ 𝐊𝐥𝐢𝐤 𝐓𝐨𝐦𝐛𝐨𝐥 𝐃𝐢𝐛𝐚𝐰𝐚𝐡 𝐔𝐧𝐭𝐮𝐤 𝐌𝐞𝐧𝐝𝐚𝐟𝐭𝐚𝐫'
}[type]
if (msgg) return conn.sendButton(m.chat, `${global.htki} VERIFY ${global.htka}`, msgg, null, ['- 𝐯𝐞𝐫𝐢𝐟𝐢 -', '/verify'],m)
}
